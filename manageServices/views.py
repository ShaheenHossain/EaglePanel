...
def manageApplications(request):
    ...
    esPath = '/home/eaglepanel/elasticsearch'
    rPath = '/home/eaglepanel/redis'
        ...
        try:
            ...
            if appName == 'Elasticsearch':
                if status == 'Installing':
                    command = '/usr/local/EagleEP/bin/python /usr/local/EagleEP/manageServices/serviceManager.py --function InstallElasticSearch'
                else:
                    command = '/usr/local/EagleEP/bin/python /usr/local/EagleEP/manageServices/serviceManager.py --function RemoveElasticSearch'
            elif appName == 'Redis':
                if status == 'Installing':
                    command = '/usr/local/EagleEP/bin/python /usr/local/EagleEP/manageServices/serviceManager.py --function InstallRedis'
                else:
                    command = '/usr/local/EagleEP/bin/python /usr/local/EagleEP/manageServices/serviceManager.py --function RemoveRedis'
