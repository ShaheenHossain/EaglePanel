...
class ServiceManager:
    ...
    slaveConfPath = '/home/eaglepanel/slaveConf'
...
'''
        ...
        command = 'touch /home/eaglepanel/elasticsearch'
        ServerStatusUtil.executioner(command, statusFile)
    ...
    def RemoveElasticSearch():
        ...
        command = 'rm -f /home/eaglepanel/elasticsearch'
        ServerStatusUtil.executioner(command, statusFile)
    ...
    def InstallRedis():
        ...
        command = 'touch /home/eaglepanel/redis'
        ServerStatusUtil.executioner(command, statusFile)
    ...
    def RemoveRedis():
        ...
        command = 'rm -f /home/eaglepanel/redis'
        ServerStatusUtil.executioner(command, statusFile)
...
def main():
    ...
    parser = argparse.ArgumentParser(description='EaglePanel Application Manager')
