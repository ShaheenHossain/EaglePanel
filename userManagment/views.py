...
from EagleEP.secMiddleware import secMiddleware
from EagleEP.SecurityLevel import SecurityLevel
    ...
    try:
        ...
        try:
            if request.method == 'POST':
                ...
                otpauth = pyotp.totp.TOTP(user.secretKey).provisioning_uri(email, issuer_name="EaglePanel")
