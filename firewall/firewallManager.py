...
class FirewallManager:
        ...
        try:
            ...
            if res == 1:
                ...
                final_dic = {'reload_status': 0,
                             'error_message': "Can not reload firewall, see EagleEP main log file."}
                final_json = json.dumps(final_dic)
                return HttpResponse(final_json)
        ...
        try:
            ...
            if res == 1:
                ...
                final_dic = {'start_status': 0,
                             'error_message': "Can not start firewall, see EagleEP main log file."}
                final_json = json.dumps(final_dic)
                return HttpResponse(final_json)
        ...
        try:
            ...
            if res == 1:
                ...
                final_dic = {'stop_status': 0,
                             'error_message': "Can not stop firewall, see EagleEP main log file."}
                final_json = json.dumps(final_dic)
                return HttpResponse(final_json)
    ...
    def installModSec(self, userID = None, data = None):
        try:
            ...
            execPath = "/usr/local/EagleEP/bin/python " + virtualHostUtilities.eaglePanel + "/plogical/modSec.py"
    ...
    def installCSF(self):
        try:
            ...
            execPath = "sudo /usr/local/EagleEP/bin/python " + virtualHostUtilities.eaglePanel + "/plogical/csf.py"
    ...
    def modifyPorts(self, data = None):
        try:
            ...
            portsPath = '/home/eaglepanel/' + str(randint(1000, 9999))
    ...
    def submitinstallImunify(self):
        try:
            ...
            logging.EagleEPLogFileWriter.statusWriter(ServerStatusUtil.lswsInstallStatusPath, str(msg) + ' [404].', 1)
    ...
    def saveLitespeed_conf(self, userID = None, data = None):
        try:
            ...
            tempRulesPath = '/home/eaglepanel/pre_main_global.conf'
