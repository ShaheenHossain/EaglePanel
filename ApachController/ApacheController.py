...
class ApacheController:
    apacheInstallStatusPath = '/home/eaglepanel/apacheInstallStatus'
...
<IfModule mpm_event_module>
    ...
    def setupApache(statusFile):
        try:
            ...
            logging.EagleEPLogFileWriter.statusWriter(statusFile, 'Starting Apache installation. It may take some time..,70')
            ...
            logging.EagleEPLogFileWriter.statusWriter(statusFile,
