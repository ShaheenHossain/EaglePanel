...
class BackupManager:
    localBackupPath = '/home/eaglepanel/localBackupPath'
    ...
    def changeFileRetention(self, request=None, userID=None, data=None):
        try:
            ...
            # logging.EagleEPLogFileWriter.writeToFile("...... FileRetentiontime...%s "%Retentiontime)

            gD = GDrive.objects.get(name=selectedAccount)
            # logging.EagleEPLogFileWriter.writeToFile("...... GDrive obj...%s " % GDrive)
            ...
            conf = gD.auth
            # logging.EagleEPLogFileWriter.writeToFile("...... conf...%s " % conf)
    ...
    def backupStatus(self, userID=None, data=None):
        try:
            ...
            final_json = json.dumps(final_dic)
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " [backupStatus]")
            return HttpResponse(final_json)
    ...
    def cancelBackupCreation(self, userID=None, data=None):
        try:
            ...
            try:
                ...
                logging.EagleEPLogFileWriter.writeToFile(str(msg) + " [cancelBackupCreation]")
        ...
        try:
            ...
            if data['type'] == 'SFTP':
                ...
                if os.path.exists(ProcessUtilities.debugPath):
                    logging.EagleEPLogFileWriter.writeToFile(execPath)
    ...
    def scheduleDelete(self, userID=None, data=None):
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(findTxt)
            logging.EagleEPLogFileWriter.writeToFile(backupFreq)

            path = "/etc/crontab"

            command = "cat " + path
            output = ProcessUtilities.outputExecutioner(command).split('\n')
            tempCronPath = "/home/eaglepanel/" + str(randint(1000, 9999))
    ...
    def submitRemoteBackups(self, userID=None, data=None):
        try:
            ...
            ## Ask for Remote version of EaglePanel

            try:
                finalData = json.dumps({'username': "admin", "password": password})

                url = "https://" + ipAddress + ":8090/api/eaglePanelVersion"
            ...
            pathToKey = "/home/eaglepanel/" + str(randint(1000, 9999))
            ...
            execPath = "/usr/local/EagleEP/bin/python " + virtualHostUtilities.eaglePanel + "/plogical/remoteTransferUtilities.py"
    ...
    def starRemoteTransfer(self, userID=None, data=None):
        try:
            ...
            try:
                ...
                ipFile = os.path.join("/etc", "eaglepanel", "machineIP")
                f = open(ipFile)
                ownIP = f.read()
    ...
    def CreateV2BackupStatus(self, userID=None, data=None):
        try:
            ...
            statusFile = f'/home/eaglepanel/{domain}_rustic_backup_log'
            ...
            #currentStatus:"cat: /home/eaglepanel/9219: No such file or directory"
        ...
        try:
            if request.GET.get('status', 'none') == 'success':
                ...
                try:
                    ...
                    payload = {
                        'sub': subscription,
                        'key': ProcessUtilities.outputExecutioner(f'cat /root/.ssh/eaglepanel.pub'),  # Replace with the actual SSH public key
    ...
    def DeployAccount(self, request=None, userID=None, data=None):
        ...
        payload = {
            ...
            'key': ProcessUtilities.outputExecutioner(f'cat /root/.ssh/eaglepanel.pub'),
