...
class CloudManager:
    ...
    def fetchSSHKey(self, request):
        try:
            pubKey = os.path.join("/root", ".ssh", 'eaglepanel.pub')
    ...
    def forceRunAWSBackup(self, request):
        try:
            ...
            execPath = "/usr/local/EagleEP/bin/python /usr/local/EagleEP/plogical/IncScheduler.py forceRunAWSBackup --planName %s" % (
                self.data['planName'])
    ...
    def RunServerLevelEmailChecks(self):
        try:
            ...
            tempStatusPath = "/home/eaglepanel/" + str(randint(1000, 9999))
            reportFile = "/home/eaglepanel/" + str(randint(1000, 9999))
    ...
    def ResetFTPConfigurations(self):
        try:
            ...
            execPath = "/usr/local/EagleEP/bin/python " + virtualHostUtilities.eaglePanel + "/ftp/ftpManager.py"
    ...
    def ResetDNSConfigurations(self):
        try:
            ...
            execPath = "/usr/local/EagleEP/bin/python " + virtualHostUtilities.eaglePanel + "/dns/dnsManager.py"
    ...
    def SubmitCloudBackup(self):
        try:
            ...
            import time
            BackupPath = '/home/eaglepanel/backups/%s/backup-' % (self.data['domain']) + self.data[
                'domain'] + "-" + time.strftime("%m.%d.%Y_%H-%M-%S")

            execPath = "/usr/local/EagleEP/bin/python " + virtualHostUtilities.eaglePanel + "/plogical/backupUtilities.py"
    ...
    def getCurrentCloudBackups(self):
        try:
            ...
            backupsPath = '/home/eaglepanel/backups/%s/' % (backupDomain)
            try:
    ...
    def deleteCloudBackup(self):
        try:
            ...
            backupsPathComplete = '/home/eaglepanel/backups/%s/%s' % (backupDomain, backupFile)
    ...
    def DeployWordPress(self):
        try:
            ...
            execPath = "/usr/local/EagleEP/bin/python " + virtualHostUtilities.eaglePanel + "/plogical/applicationInstaller.py"
    ...
    def AutoLogin(self):
        try:
            ...
            command = 'wp user create eaglepanel support@eaglepanel.cloud --role=administrator --user_pass="%s" --path=%s --skip-plugins --skip-themes' % (
            password, path)
            ProcessUtilities.executioner(command, website.externalApp)

            command = 'wp user update eaglepanel --user_pass="%s" --path=%s --skip-plugins --skip-themes' % (password, path)
            ProcessUtilities.executioner(command, website.externalApp)
    ...
    def SubmitPublicKey(self):
        try:
            ...
            try:
                BackupPath = '/home/eaglepanel/backups/%s' % (self.data['domain'])
    ...
    def SubmitEaglePanelUpgrade(self):
        try:
            try:
            ...
            execPath = "/usr/local/EagleEP/bin/python /usr/local/EagleEP/plogical/EaglePanelUpgrade.py --branch %s --mail %s --dns %s --ftp %s" % (
            self.data['EaglePanelBranch'], mail, dns, ftp)
    ...
    def DetachCluster(self):
        try:
            ...
            execPath = "/usr/local/EagleEP/bin/python /usr/local/EagleEP/plogical/ClusterManager.py --function %s --type %s" % ('DetachCluster', type)
            ProcessUtilities.executioner(execPath)
    ...
    def SetupCluster(self):
        try:
            ...
            ClusterConfigPath = '/home/eaglepanel/cluster'
            writeToFile = open(ClusterConfigPath, 'w')
            writeToFile.write(json.dumps(self.data))
            writeToFile.close()

            execPath = "/usr/local/EagleEP/bin/python /usr/local/EagleEP/plogical/ClusterManager.py --function SetupCluster --type %s" % (self.data['type'])
            ProcessUtilities.executioner(execPath)
    ...
    def BootMaster(self):
        try:
            ...
            execPath = "/usr/local/EagleEP/bin/python /usr/local/EagleEP/plogical/ClusterManager.py --function BootMaster --type Master"
            ProcessUtilities.executioner(execPath)
    ...
    def BootChild(self):
        try:
            ...
            ChildData = '/home/eaglepanel/childaata'
            writeToFile = open(ChildData, 'w')
            writeToFile.write(json.dumps(self.data))
            writeToFile.close()

            execPath = "/usr/local/EagleEP/bin/python /usr/local/EagleEP/plogical/ClusterManager.py --function BootChild --type Child"
            ProcessUtilities.executioner(execPath)
    ...
    def CreatePendingVirtualHosts(self):
        try:
            ...
            execPath = "/usr/local/EagleEP/bin/python /usr/local/EagleEP/plogical/ClusterManager.py --function CreatePendingVirtualHosts --type Child"
            ProcessUtilities.popenExecutioner(execPath)
    ...
    def SwitchDNS(self):
        try:
            ...
            command = 'chown -R eaglepanel:eaglepanel /usr/local/EagleEP/lib/python3.8/site-packages/tldextract/.suffix_cache/'
            ProcessUtilities.executioner(command)
    ...
    def DebugCluster(self):
        try:
            ...
            execPath = "/usr/local/EagleEP/bin/python /usr/local/EagleEP/plogical/ClusterManager.py --function %s --type %s" % ('DebugCluster', type)
            ProcessUtilities.executioner(execPath)
    ...
    def UptimeMonitor(self):
        try:
            ...
            CloudConfigPath = '/home/eaglepanel/cloud'
            writeToFile = open(CloudConfigPath, 'w')
            writeToFile.write(json.dumps(self.data))
            writeToFile.close()

            execPath = "/usr/local/EagleEP/bin/python /usr/local/EagleEP/plogical/ClusterManager.py --function UptimeMonitor --type All"
            ProcessUtilities.executioner(execPath)
    ...
    def SyncToMaster(self):
        try:
            ...
            command = '/usr/local/EagleEP/bin/python /usr/local/EagleEP/plogical/ClusterManager.py --function SyncToMaster --type Failover'
            ProcessUtilities.executioner(command)
