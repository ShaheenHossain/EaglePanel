...
def router(request):
    try:
        ...
        if controller == 'verifyLogin':
        ...
        elif controller == 'SubmitEaglePanelUpgrade':
            return cm.SubmitEaglePanelUpgrade()
            ...
            return cm.ajaxPre(0, 'This function is not available in your version of EaglePanel.')
