...
${PURPLE}1.${NC} How to reset EaglePanel admin password?
...
Please check this post: ${GREEN}https://forums.eaglepanel.net/discussion/87/tutorial-how-to-setup-and-login-to-openlitespeed-webadmin-console/p1${NC}

${BLUE}------------------------------------------------------------${NC}

${PURPLE}4.${NC} What is MariaDB root password ?

execute command ${RED}cat /etc/eaglepanel/mysqlPassword${NC} will show you the root password
...
${RED}/etc/eaglepanel/mysqlPassword${NC}

${RED}/usr/local/EagleEP/EagleEP/settings.py${NC}

otherwise EaglePanel will not have access to database.

${BLUE}------------------------------------------------------------${NC}

${PURPLE}6.${NC} How to raise upload limit for eaglepanel's phpMyAdmin and File Manager?
...
For OpenLiteSpeed, please check this post: ${GREEN}https://forums.eaglepanel.net/discussion/126/tutorial-how-to-add-2nd-ip-for-websites/p1${NC}

For LiteSpeed Enterprise, please check this post: ${GREEN}https://forums.eaglepanel.net/discussion/3745/tutorial-how-to-add-2nd-ip-for-litespeed-enterprise/p1${NC}

${BLUE}------------------------------------------------------------${NC}

${PURPLE}8.${NC} How to remove 8090 port in EaglePanel URL ?

Please check this post ${GREEN}https://blog.eaglepanel.net/2018/12/25/how-to-remove-port-8090-from-eaglepanel/${NC}

${BLUE}------------------------------------------------------------${NC}

${PURPLE}9.${NC} How to enable Auto-Index for my site ?

Please check this post ${GREEN}https://forums.eaglepanel.net/discussion/3850/tutorial-how-to-enable-auto-index-on-openlitespeed-and-litespeed-enterprise${NC}
...
Please check this post ${GREEN}https://forums.eaglepanel.net/discussion/3977/tutorial-how-to-enable-php-error-log/p1${NC}
"