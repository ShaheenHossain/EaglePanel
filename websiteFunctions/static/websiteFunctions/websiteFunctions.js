...
app.controller('listWebsites', function ($scope, $http) {
    ...
    $scope.eaglePanelLoading = true;

    $scope.issueSSL = function (virtualHost) {
        $scope.eaglePanelLoading = false;
...
app.controller('websitePages', function ($scope, $http, $timeout, $window) {
    ...
    const httpToHTTPS = `### Rewrite Rules Added by EaglePanel Rewrite Rule Generator

RewriteEngine On
RewriteCond %{HTTPS}  !=on
RewriteRule ^/?(.*) https://%{SERVER_NAME}/$1 [R,L]

### End EaglePanel Generated Rules.

`;

    const WWWToNonWWW = `### Rewrite Rules Added by EaglePanel Rewrite Rule Generator
...
`;
    ...
    const nonWWWToWWW = `### Rewrite Rules Added by EaglePanel Rewrite Rule Generator
...
`;
    ...
    const WordpressProtect = `### Rewrite Rules Added by EaglePanel Rewrite Rule Generator
