...
class CageFS:
    ...
    def submitCageFSInstall():
        try:
            ...
            activatedPath = '/home/eaglepanel/cloudlinux'
    ...
    def submitinstallImunify(key):
        try:
            ...
            imunifyKeyPath = '/home/eaglepanel/imunifyKeyPath'
            ...
            content = """[paths]
ui_path =/usr/local/EagleEP/public/imunify
[web_server]
...
"""
            ...
            command = 'mkdir /usr/local/EagleEP/public/imunify'
    ...
    def submitinstallImunifyAV():
        try:
            ...
            content = """[paths]
ui_path = /usr/local/EagleEP/public/imunifyav
...
"""
            ...
            command = 'mkdir /usr/local/EagleEP/public/imunifyav'
            ProcessUtilities.executioner(command)
...
def main():
    ...
    parser = argparse.ArgumentParser(description='EaglePanel CageFS Manager')
