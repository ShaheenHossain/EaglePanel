...
## This event is fired before EaglePanel core load the create ftp template, this special event is used
...
## This event is fired before EaglePanel core start creation of a FTP account.
preSubmitFTPCreation = Signal(providing_args=["request"])

## This event is fired after EaglePanel core finished creation of a FTP account.
postSubmitFTPCreation = Signal(providing_args=["request", "response"])

## This event is fired before EaglePanel core start deletion of a FTP account.
