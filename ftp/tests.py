...
class TestFTP(TestCase):
    ...
    def test_submitFTPCreation(self):
        ...
        data_ret = {'ftpDomain': 'eaglepanel.xyz', 'ftpUserName':'hello', 'passwordByPass':'helloworld'}
        ...
        self.assertEqual(os.path.exists('/home/eaglepanel.xyz/unittest'), True)
