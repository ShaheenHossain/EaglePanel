...
class FTPManager:
    ...
    def createFTPAccount(self):
        ...
        if not os.path.exists('/home/eaglepanel/pureftpd'):
    ...
    def installPureFTPDConfigurations(self, mysqlPassword):
        ...
        #         shutil.copytree("/usr/local/EagleEP/install/pure-ftpd-one", ftpdPath)
        #
        #     else:
        #         shutil.copytree("/usr/local/EagleEP/install/pure-ftpd-one", ftpdPath)
        #
        ...
        try:
            ...
            try:
                ...
                logging.EagleEPLogFileWriter.writeToFile("[ERROR] Could not create directory for FTP SSL")
            ...
            if ProcessUtilities.decideDistro() == ProcessUtilities.ubuntu or ProcessUtilities.decideDistro() == ProcessUtilities.ubuntu20:
                try:
                    ...
                    logging.EagleEPLogFileWriter.writeToFile("[ERROR] Error creating extra pure-ftpd directories: " + str(msg), ".  Should be ok", 1)
                    logging.EagleEPLogFileWriter.statusWriter(self.extraArgs['tempStatusPath'], "[ERROR] Error creating extra pure-ftpd directories: " + str(msg), "" + " [installPureFTPDConfigurations][404]")
                    return 0
            ...
            logging.EagleEPLogFileWriter.writeToFile('[ERROR] ' + str(msg) + " [installPureFTPDConfigurations]")
            logging.EagleEPLogFileWriter.statusWriter(self.extraArgs['tempStatusPath'], '[ERROR] ' + str(msg) + " [installPureFTPDConfigurations][404]")
            return 0
    ...
    def ResetFTPConfigurations(self):
        try:
            ...
            logging.EagleEPLogFileWriter.statusWriter(self.extraArgs['tempStatusPath'], 'Removing and re-installing FTP..,5')
            ...
            if self.installPureFTPDConfigurations(settings.DATABASES['default']['PASSWORD']) == 0:
                logging.EagleEPLogFileWriter.statusWriter(self.extraArgs['tempStatusPath'], 'installPureFTPDConfigurations failed. [404].')
                return 0
