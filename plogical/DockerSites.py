...
services:
  '{self.data['ServiceName']}':
    user: root
    image: eaglepanel/openlitespeed:latest
    ports:
      - "{self.data['port']}:8088"
#      - "443:443"
    environment:
...
'''
            ...
            TempCompose = f'/home/eaglepanel/{self.data["finalURL"]}-docker-compose.yml'
            ...
            execPath = "/usr/local/EagleEP/bin/python /usr/local/EagleEP/plogical/DockerSites.py"
...
def Main():
    try:
        ...
        parser = argparse.ArgumentParser(description='EaglePanel Docker Sites')
        ...
        if args.function == "SetupProxy":
            ...
            # finalURL, blogTitle, adminUser, adminPassword, adminEmail, htaccessPath, externalApp
            data = {
                "JobID": '/home/eaglepanel/hey.txt',
                "ComposePath": "/home/docker.eaglepanel.net/docker-compose.yml",
                "MySQLPath": '/home/docker.eaglepanel.net/public_html/sqldocker',
                ...
                "MemoryMySQL": '512',
                "port": '8000',
                "SitePath": '/home/docker.eaglepanel.net/public_html/wpdocker',
                "CPUsSite": '2',
                "MemorySite": '512',
                "SiteName": 'wp docker test',
                "finalURL": 'docker.eaglepanel.net',
                "blogTitle": 'docker site',
                "adminUser": 'testdbwp',
                "adminPassword": 'testdbwp',
                "adminEmail": 'usman@cyberpersons.com',
                "htaccessPath": '/home/docker.eaglepanel.net/public_html/.htaccess',
                "externalApp": 'docke8463',
                "docRoot": "/home/docker.eaglepanel.net"
            }
