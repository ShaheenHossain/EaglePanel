...
class sslUtilities:
    ...
    def FindIfDomainInCloudflare(virtualHostName):
        try:
            ...
            if RetStatus:
                ...
                logging.EagleEPLogFileWriter.writeToFile(f'top level domain in cf: {topLevelDomain}')
                import CloudFlare
                ...
                for zone in sorted(zones, key=lambda v: v['name']):
                    logging.EagleEPLogFileWriter.writeToFile(f'zone: {zone["name"]}')
    ...
    def obtainSSLForADomain(virtualHostName, adminEmail, sslpath, aliasDomain=None):
        ...
        if CF_Check:
            ...
            EaglePanel_Check, message = sslUtilities.FindIfDomainInPowerDNS(virtualHostName)
        ...
        try:
            ...
            if aliasDomain is None:
                ...
                try:
                    ...
                    logging.EagleEPLogFileWriter.SendEmail(sender_email, adminEmail, output,
