...
class DNS:
    ...
    CFPath = '/home/eaglepanel/CloudFlare'
    ...
    def loadCFKeys(self):
        ...
        if os.path.exists(cfFile):
            ...
            #logging.EagleEPLogFileWriter.writeToFile('User %s does not have CloudFlare configured.' % (self.admin.userName))
            return 0
        ...
        try:
            ...
            if self.loadCFKeys():
                ...
                try:
                    ...
                    logging.EagleEPLogFileWriter.writeToFile(str(e))
    ...
    def createDNSRecordCloudFlare(cf, zone, name, type, value, priority, ttl):
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + '. [createDNSRecordCloudFlare]')
    ...
    def createDNSRecord(zone, name, type, value, priority, ttl):
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " [createDNSRecord]")
...
"""
            ...
            logging.EagleEPLogFileWriter.writeToFile(f'ConfigurePowerDNSInAcme, Error: {str(msg)}')
            return 0, str(msg)
...
"""
            ...
            logging.EagleEPLogFileWriter.writeToFile(f'ConfigureCloudflareInAcme, Error: {str(msg)}')
            return 0, str(msg)
