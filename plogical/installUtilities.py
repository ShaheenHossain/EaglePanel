...
class installUtilities:
    ...
    def enableEPELRepo():
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " [enableEPELRepo]")
            return 0
    ...
    def addLiteSpeedRepo():
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " [addLiteSpeedRepo]")
            return 0
        except ValueError as msg:
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " [addLiteSpeedRepo]")
            return 0
    ...
    def installLiteSpeed():
        ...
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " [installLiteSpeed]")
            return 0
        except ValueError as msg:
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " [installLiteSpeed]")
            return 0
    ...
    def startLiteSpeed():
        ...
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " [startLiteSpeed]")
            return 0
        except ValueError as msg:
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " [startLiteSpeed]")
            return 0
    ...
    def reStartLiteSpeed():
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " [reStartLiteSpeed]")
            return 0
    ...
    def reStartOpenLiteSpeed(restart,orestart):
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " [reStartOpenLiteSpeed]")
            return 0
        except ValueError as msg:
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " [reStartOpenLiteSpeed]")
            return 0
    ...
    def changePortTo80():
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " [changePortTo80]")
            return 0
    ...
    def installAllPHPVersion():
        ...
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " [installAllPHPVersion]")
    ...
    def installAllPHPToLitespeed():
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " [installAllPHPToLitespeed]")
            return 0
    ...
    def removeWebServer():
        ...
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " [removeWebServer]")
            return 0
        except ValueError as msg:
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " [removeWebServer]")
            return 0
    ...
    def startMariaDB():
        ...
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " [startMariaDB]")
            return 0
        except ValueError as msg:
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " [startMariaDB]")
            return 0
    ...
    def installMySQL(password):
        ...
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " [installMySQL]")
        ...
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " Could not add mariadb to startup [installMySQL]")
            return 0
        except ValueError as msg:
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " Could not add mariadb to startup [installMySQL]")
            return 0
    ...
    def secureMysqlInstallation(password):
        ...
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " Exception EOF [installMySQL]")
            print("###########################Before########################################")
