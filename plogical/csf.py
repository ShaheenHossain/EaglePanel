...
class CSF(multi.Thread):
    installLogPath = "/home/eaglepanel/csfInstallLog"
    ...
    def run(self):
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + ' [CSF.run]')
    ...
    def installCSF():
        try:
            ...
            logging.EagleEPLogFileWriter.statusWriter(CSF.installLogPath, 'Downloading CSF..\n', 1)
            ...
            logging.EagleEPLogFileWriter.statusWriter(CSF.installLogPath, 'Extracting CSF..\n', 1)
            ...
            logging.EagleEPLogFileWriter.statusWriter(CSF.installLogPath, 'Installing CSF..\n', 1)

            os.chdir('csf')


            ### manually update csf views.py because it does not load EaglePanel properly in default configurations
...
def configservercsfiframe(request):
    ...
    try:
        ...
        tmp.write(qs)
        tmp.close()
        command = "/usr/local/csf/bin/eaglepanel.pl '" + tmp.name + "'"
...
'''
            ...
            WriteToFile = open('eaglepanel/configservercsf/views.py', 'w')
            ...
            if ProcessUtilities.decideDistro() == ProcessUtilities.centos or ProcessUtilities.decideDistro() == ProcessUtilities.cent8:
                ...
                logging.EagleEPLogFileWriter.statusWriter(CSF.installLogPath,
            ...
            for items in data:
                ...
                #    writeToConf.writelines('UI_USER = "eaglepanel"\n')
            ...
            logging.EagleEPLogFileWriter.statusWriter(CSF.installLogPath, 'CSF successfully Installed.[200]\n', 1)
            ...
            writeToFile.close()
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + "[installCSF]")
    ...
    def removeCSF(self):
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + "[removeCSF]")
    ...
    def fetchCSFSettings():
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " [fetchCSFSettings]")
    ...
    def changeStatus(controller, status):
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + "[changeStatus]")
            print('0', str(msg))
    ...
    def modifyPorts(protocol, portsPath):
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + "[modifyPorts]")
            print('0', str(msg))
    ...
    def allowIP(ipAddress):
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + "[allowIP]")
    ...
    def blockIP(ipAddress):
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + "[blockIP]")
    ...
    def checkIP(ipAddress):
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + "[checkIP]")
