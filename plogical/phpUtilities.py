...
class phpUtilities:
    ...
    installLogPath = "/home/eaglepanel/phpExtensionRequestLog"
    ...
    def installPHPExtension(extension,extensions):
        try:
            ...
            try:
                ...
                writeToFile.close()
                logging.EagleEPLogFileWriter.writeToFile("[Could not Install]")
                installUtilities.installUtilities.reStartLiteSpeed()
                return 0
        except BaseException as msg:
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + "[installPHPExtension]")
    ...
    def unInstallPHPExtension(extension,extensions):
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + "[unInstallPHPExtension]")
    ...
    def initiateInstall(extension):
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " [initiateInstall]")
    ...
    def GetPHPVersionFromFile(vhFile, domainName=None):
        ...
        if os.path.exists('/usr/local/EagleEP/debug'):
            logging.EagleEPLogFileWriter.writeToFile(f'VHFile in GetPHPVersion {vhFile}')
