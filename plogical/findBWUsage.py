...
class findBWUsage:
    ...
    def calculateBandwidth(domainName):
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " [calculateBandwidth]")
            return 0
    ...
    def startCalculations():
        try:
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " [startCalculations]")
            return 0
    ...
    def changeSystemLanguage():
        try:
            ...
            if res == 1:
                logging.EagleEPLogFileWriter.writeToFile("1440 [setup_cron]")
            else:
                pass
            ...
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " [changeSystemLanguage]")
            return 0
        except ValueError as msg:
            logging.EagleEPLogFileWriter.writeToFile(str(msg) + " [changeSystemLanguage]")
            return 0
