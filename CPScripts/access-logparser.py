...
def main():
    ...
    try:
        ...
        elif os.path.isfile('/usr/bin/eaglepanel') | os.path.isfile(os.getcwd() + '/eaglepanel'):
    ...
    if username == 'root' and controlpanel == 'EaglePanel':
        # Needs updated to glob all /home/*/logs/
        path = '/home/*/logs/*'
        domlogs_path = glob.glob("/home/*/logs/")
        print('Root EaglePanel Detected')
    ...
    if controlpanel == 'Cpanel' or controlpanel == 'EaglePanel':
